...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2021 a las 20:25:58
...
INSERT INTO `admin` (`id`, `user`, `pass`, `last_login`, `role`) VALUES
(1, 'admin', '202cb962ac59075b964b07152d234b70', 'Monday 18th Oct', 1),
(2, 'super_admin_1', '202cb962ac59075b964b07152d234b70', 'Friday 23rd Jul', 2),
(3, 'super_admin_2', '202cb962ac59075b964b07152d234b70', 'Wednesday 7th J', 2),
(8, 'admin_9', '202cb962ac59075b964b07152d234b70', 'Friday 23rd Jul', 2);
...
CREATE TABLE `agenda` (
  ...
  `fecha_hora_end` varchar(45) NOT NULL,
  ...
  `pago_estado` varchar(45) NOT NULL,
...
CREATE TABLE `codigos_promo` (
  ...
  `caducidad` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `distritos` (`id`, `name`, `province_id`, `department_id`) VALUES
...
(8, 'Cirujano pediátrico', 'cirujano-pediatrico'),
(9, 'Cirujano plástico', 'cirujano-plastico'),
(10, 'Cirujano vascular', 'cirujano-vascular'),
(11, 'Dentista', 'dentista'),
(12, 'Dermatólogo', 'dermatologo'),
(13, 'Endocrinólogo', 'endocrinologo'),
(14, 'Enfermero', 'enfermero'),
(15, 'Epidemiólogo', 'epidemiologo'),
(16, 'Especialista en Administración de Salud', 'especialista-en-administracion-de-salud'),
(17, 'Especialista en Emergencias', 'especialista-en-emergencias'),
(18, 'Especialista en Medicina Estética', 'especialista-en-medicina-estetica'),
(19, 'Especialista en Medicina Física y Rehabilitación', 'especialista-en-medicina-fisica-y-rehabilitacion'),
(20, 'Especialista en Medicina Intensiva', 'especialista-en-medicina-intensiva'),
(21, 'Especialista en Medicina Natural', 'especialista-en-medicina-natural'),
(22, 'Especialista en Medicina Nuclear', 'especialista-en-medicina-nuclear'),
(23, 'Especialista en Radioterapia', 'especialista-en-radioterapia'),
(24, 'Especialista en Salud Pública', 'especialista-en-salud-publica'),
(26, 'Farmacólogo', 'farmacologo'),
(27, 'Fisioterapeuta', 'fisioterapeuta'),
(28, 'Fonoaudiólogo', 'fonoaudiologo'),
(29, 'Gastroenterólogo', 'gastroenterologo'),
(30, 'Genetista', 'genetista'),
(31, 'Geriatra', 'geriatra'),
(32, ' Ginecólogo', 'ginecologo'),
(33, 'Hematólogo', 'hematologo'),
(34, 'Homeópata', 'homeopata'),
(35, 'Infectólogo', 'infectologo'),
(36, 'Internista', 'internista'),
(37, 'Médico del Deporte', 'medico-del-deporte'),
(38, 'Médico del Trabajo', 'medico-del-trabajo'),
(39, 'Médico familiar', 'medico-familiar'),
(40, 'Médico general', 'medico-general'),
(41, 'Médico legal', 'medico-legal'),
(42, 'Médico ocupacional', 'medico-ocupacional'),
(43, 'Nefrólogo', 'nefrologo'),
(44, 'Neonatólogo', 'neonatologo'),
(45, 'Neumólogo', 'neumologo'),
(46, 'Pediátrico', 'pediatrico'),
(47, 'Neurocirujano', 'neurocirujano'),
(48, 'Neurofisiólogo clínico', 'neurofisiologo-clinico'),
(49, 'Neurólogo', 'neurologo'),
(50, 'Nutricionista', 'nutricionista'),
(51, 'Internista', 'internista'),
(53, 'Médico del Trabajo', 'medico-del-trabajo'),
(54, 'Médico familiar', 'medico-familiar'),
(55, 'Médico general', 'medico-general'),
(56, 'Médico legal', 'medico-legal'),
(57, 'Médico ocupacional', 'medico-ocupacional'),
(58, 'Oftalmólogo', 'oftalmologo'),
(59, 'Oncólogo', 'oncologo'),
(60, 'Óptico', 'optico'),
(61, 'Otorrino', 'otorrino'),
(62, 'Patólogo', 'patologo'),
(63, 'Patólogo clínico', 'patologo-clinico'),
(64, 'Pediatra', 'pediatra'),
(65, 'Podólogo', 'podologo'),
(66, 'Psicólogo', 'psicologo'),
(67, 'Psiquiatra', 'psiquiatra'),
(68, 'Quiropráctico', 'quiropractico'),
(69, 'Radiólogo', 'radiologo'),
(70, 'Reumatólogo', 'reumatologo'),
(71, 'Técnico en Laboratorio Clínico', 'tecnico-en-laboratorio-clinico'),
(72, 'Terapeuta complementario', 'terapeuta-complementario'),
(73, 'Traumatólogo y Ortopedista', 'traumatologo-y-ortopedista'),
(74, 'Urólogo', 'urologo');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `exepciones`
--

CREATE TABLE `exepciones` (
  `id` int(11) NOT NULL,
  `cod_med` varchar(45) NOT NULL,
  `exepciones` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`exepciones`)),
  `estado` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `historial_medico` (
  ...
  `historia_clinica` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`historia_clinica`)),
  `analisis_lab` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`analisis_lab`)),
  `img_digitales` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`img_digitales`)),
  `recetas_med` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`recetas_med`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `medicos` (
  ...
  `periodo_membresia` int(11) NOT NULL,
  `token_confirm` varchar(45) NOT NULL,
...
--
-- Estructura de tabla para la tabla `medico_bank`
--

CREATE TABLE `medico_bank` (
  `id` int(11) NOT NULL,
  `token_medico` varchar(45) NOT NULL,
...
INSERT INTO `membresias` (`id`, `precio`, `tipo_membresia`) VALUES
(1, '750.00', 'Profesional');
...
CREATE TABLE `pagos_externos` (
  `id` int(11) NOT NULL,
  `cod_externo` varchar(45) NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Estructura de tabla para la tabla `pagos_medicos`
--
...
CREATE TABLE `pagos_membresias` (
  `id` int(11) NOT NULL,
  `pagoMembresia` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`pagoMembresia`)),
  `token_medico` varchar(45) NOT NULL,
  `cod_pago` varchar(45) NOT NULL,
  `monto_pago` decimal(16,2) NOT NULL,
  `token_referido` varchar(45) DEFAULT NULL,
  `monto_reducido_token` decimal(16,2) DEFAULT NULL,
  `fecha` date NOT NULL,
...
CREATE TABLE `perfil` (
  ...
  `tipo_colegiado_doc` varchar(50) NOT NULL,
  `num_colegiatura` varchar(150) DEFAULT NULL,
  `especialidad` varchar(100) DEFAULT NULL,
  `otros_nro_colegiatura` varchar(150) DEFAULT NULL,
  `otras_especialidades` varchar(150) DEFAULT NULL,
  `servicios` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `nombre_clinica` varchar(100) DEFAULT NULL,
  `direccion_clinica` varchar(100) DEFAULT NULL,
  `precio_consulta` decimal(16,2) DEFAULT NULL,
  `precio_online` decimal(16,2) DEFAULT NULL,
  `codigo_referido` text DEFAULT NULL,
  `fotos_varias` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`fotos_varias`)),
  `certificados` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`certificados`)),
  `formacion` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`formacion`)),
  `premios` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`premios`)),
  `check_tel` int(11) DEFAULT NULL,
  `check_correo` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `referidos_externos`
--

CREATE TABLE `referidos_externos` (
  `id` int(11) NOT NULL,
...
--
-- Indices de la tabla `exepciones`
--
ALTER TABLE `exepciones`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `medico_bank`
--
ALTER TABLE `medico_bank`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `pagos_medicos`
--
ALTER TABLE `pagos_medicos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pagos_membresias`
--
ALTER TABLE `pagos_membresias`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `referidos_externos`
--
ALTER TABLE `referidos_externos`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `exepciones`
--
ALTER TABLE `exepciones`
...
--
-- AUTO_INCREMENT de la tabla `medico_bank`
--
ALTER TABLE `medico_bank`
...
--
-- AUTO_INCREMENT de la tabla `pagos_medicos`
--
ALTER TABLE `pagos_medicos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT de la tabla `pagos_membresias`
--
ALTER TABLE `pagos_membresias`
...
--
-- AUTO_INCREMENT de la tabla `referidos_externos`
--
ALTER TABLE `referidos_externos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
