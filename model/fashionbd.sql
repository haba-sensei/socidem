...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2020 a las 00:30:41
...
INSERT INTO `admin` (`id`, `user`, `pass`, `correo`, `nivel`, `last_login`) VALUES
(1, 'master', '21232f297a57a5a743894a0e4a801fc3', 'admin@gmail.com', 'master', 'Monday 23rd November 2020 03:30:11 AM');
...
(1, '9d0e4e43e2a98ddd30a014017a894602_.png', 'javascript:', 'save 30%', 'Hombres'),
(2, 'f256bbc06cc01e8d8004dabbc5fa71c5_.png', 'javascript:', 'save 60%', 'Mujeres');
...
(1, '7432ac0764823d8caa40557b0516d818_.png', 'casual collection', 'festive sale', 'javascript:'),
...
(1, '5ff7182cea55932a4d4562e7635587c6_.png', '2020', 'fashion trends', 'special offer');
...
CREATE TABLE `orden_menu` (
  ...
  `page_title` text COLLATE utf8_spanish2_ci NOT NULL,
  `page_url` text COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `orden_menu` (`page_id`, `page_title`, `page_url`, `page_order`) VALUES
(1, 'Nosotros', 'nosotros', 2),
(2, 'Comprar', 'comprar', 1),
(3, 'Vendedores', 'vendedores', 3),
(4, 'Contacto', 'contacto', 4),
(5, '¿Cómo ser vendedor?', 'solicitudes#become', 5);
...
(6, 'haba.dev.oficial@gmail.com\r\n', '12312312321312', 'venez', 'asdad', 'asddsdsa', 'asdqw qweqwe qweqweq', '6.jpg', '12.jpg', 'alksdjaskdaslñ djaskld jaskdlajsdlk asjdalsk djasldkjas lkdajs dakljsdak jdakld jadkl jadklajs dlkajd a kjdadkjadklajsdkj', 'normal', '{\"log_rating\":{\"1\":{\"idProd\":\"1\",\"rating\":\"3\"},\"2\":{\"idProd\":\"2\",\"rating\":\"3\"},\"3\":{\"idProd\":\"3\",\"rating\":\"3\"}}}'),
(7, 'lycantroponatural@gmail.com', '3213213123123123', 'asdsadasdsdd', 'sadasdasdad', 'qweqwdqsasc', 'asdasdadasdasd', '7.jpg', '12.jpg', 'eqweqwewqe qweqw eqwqwe qwe qweqw eqwe qweqwe qweqw eqwwe qqweqeqw eqw qwe qweqwe qw', 'normal', '{\"log_rating\":{\"1\":{\"idProd\":\"1\",\"rating\":\"3\"},\"2\":{\"idProd\":\"2\",\"rating\":\"3\"},\"3\":{\"idProd\":\"3\",\"rating\":\"3\"}}}');
...
INSERT INTO `seguidores` (`id`, `seguidor`, `seguido`, `aprob`, `fecha`) VALUES
(1, 1, 2, 1, '20/12/2020');
...
(1, '45584a9d07b30b8305435e3fbb8086e0_.png', 'welcome to fashion', 'men fashion', 'javascript:', 'Comprar Ahora'),
...
(1, 'admin', 'master2', 'admin_user', 'lycantroponatural@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'cliente', 1, 'Saturday 5th December 2020 06:27:51 PM'),
(2, 'jorge', 'acosta', 'asd', 'lycantroponatural2@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'vendedor', 1, 'Wednesday 11th November 2020 06:59:04 PM'),
...
(6, 'jorge ', 'acosta', 'g', 'haba.dev.oficial@gmail.com', 'e1c40b9dff3d83582dc192afec007bf2', 'cliente', 1, 'Tuesday 10th November 2020 01:16:26 PM'),
(7, 'algo', 'asdasd', 'haba', 'lycantroponatural@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'vendedor', 1, 'Saturday 5th December 2020 06:27:51 PM');
...
ALTER TABLE `productos`
  ...
  ADD CONSTRAINT `productos_ibfk_2` FOREIGN KEY (`id_vendedor`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
