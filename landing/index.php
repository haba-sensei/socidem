...
<!-- Mirrored from nischinto-html.netlify.app/nischinto/index13.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Jun 2021 17:51:11 GMT -->
        ...
        <div class="st-top-header-in">
          <ul class="st-top-header-list">            
            <li>
              ...
              <a href="#">info@medicos_en_directo.com</a></li>
            <li>
      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-main-header-left">
            <a class="st-site-branding" href="index.html"><img src="../views/assets/img/logo.png" style="width: 174px;" alt="Nischinto"></a>
          </div>
          <div class="st-main-header-right">
            <div class="st-nav">
              <ul class="st-nav-list st-onepage-nav">
                <li><a href="#home" class="st-smooth-move">Inicio</a></li>
                <li><a href="#faq" class="st-smooth-move">Preguntas Frecuentes</a></li>
                <li><a href="#contact" class="st-smooth-move">Contactanos</a></li>
      ...
      <div class="st-hero st-style1 st-type1">
        <div class="container">
          <div class="st-hero-text" style="top: -32px;">
            <h1 class="st-hero-title">Registrate <br>y Gana  S/ 250</h1>
            
            <div class="st-hero-subtitle">Al registrarte podras ganar desde S/ 250 refiriendo<br> codigos promocionales a medicos profesionales.</div>
          ...
          <form method="POST" id="form_req" class="st-appointment-form">
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="st-form-field st-style1">
                  <input type="text" id="razon" name="razon" placeholder="Razon Social" required>
                  
                </div>
              </div>
              <div class="col-lg-12">
                <div class="st-form-field st-style1">
                  <input type="text" id="cci" name="cci" placeholder="CCI " required>
                  
                </div>
              </div>
               
              <div class="col-lg-12">
                <button class="st-btn st-style1 st-color1 st-size-medium w-100" type="button" onclick="registro()">Inscribirme</button>
              </div>
            </div>
          </form> 
        </div>
    ...
    <section class="st-faq-wrap st-shape-wrap" id="faq">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <h2 class="st-accordian-heading">Preguntas Frecuentes</h2>
    ...
    <section class="st-shape-wrap" id="contact">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Contactanos y envianos tus dudas !</h2>
          
          <div class="st-section-heading-subtitle">Puedes Contactarnos y nuestro equipo tecnico resolvera todas tus dudas no dejes pasar esta oportunidad!</div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <div id="st-alert"></div>
            <form action="https://nischinto-html.netlify.app/nischinto/assets/php/mail.php" class="row st-contact-form st-type1" method="post"  id="contact-form">
              <div class="col-lg-6">
                <div class="st-form-field st-style1">
                  <label>Nombre</label>
              ...
              <div class="col-lg-6">
                <div class="st-form-field st-style1">
                  ...
                  <input type="text" id="phone" name="phone" placeholder="+51 376124651" required>
                </div>
              </div><!-- .col -->
              <div class="col-lg-12">
                <div class="st-form-field st-style1">
                  <label>Tu mensaje</label>      
                  <textarea cols="30" rows="10" id="msg" name="msg" placeholder="Escribe un mensaje..." required></textarea>
                </div>
              </div><!-- .col -->
              <div class="col-lg-12">
                <div class="text-center">
                  <div class="st-height-b10 st-height-lg-b10"></div>
                  <button class="st-btn st-style1 st-color1 st-size-medium" type="submit" id="submit" name="submit">Enviar </button>
                </div>
              </div><!-- .col -->
            </form>
          </div><!-- .col -->
