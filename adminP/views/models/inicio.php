    ...
    <div class="header">
        ...
        <ul class="nav user-menu">
                                    ...
                                    <div class="media">
                                        <span class="avatar avatar-sm">
                                            <img class="avatar-img rounded-circle" alt="User Image"
                                                src="adminP/assets/img/doctors/doctor-thumb-01.jpg">
                                        </span>
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media">
                                        <span class="avatar avatar-sm">
                                            <img class="avatar-img rounded-circle" alt="User Image"
                                                src="adminP/assets/img/patients/patient1.jpg">
                                        </span>
                                        <div class="media-body">
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media">
                                        <span class="avatar avatar-sm">
                                            <img class="avatar-img rounded-circle" alt="User Image"
                                                src="adminP/assets/img/patients/patient2.jpg">
                                        </span>
                                        <div class="media-body">
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media">
                                        <span class="avatar avatar-sm">
                                            <img class="avatar-img rounded-circle" alt="User Image"
                                                src="adminP/assets/img/patients/patient3.jpg">
                                        </span>
                                        <div class="media-body">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                    <span class="user-img"><img class="rounded-circle" src="adminP/assets/img/profiles/avatar-01.jpg"
                            width="31" alt="Ryan Taylor"></span>
                </a>
                <div class="dropdown-menu">
                    <div class="user-header">
                        <div class="avatar avatar-sm">
                            <img src="adminP/assets/img/profiles/avatar-01.jpg" alt="User Image"
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="mr-2 avatar avatar-sm"><img
                                                            class="avatar-img rounded-circle"
                                                            src="adminP/assets/img/doctors/doctor-thumb-02.jpg"
                                                            alt="User Image"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="mr-2 avatar avatar-sm"><img
                                                            class="avatar-img rounded-circle"
                                                            src="adminP/assets/img/doctors/doctor-thumb-03.jpg"
                                                            alt="User Image"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="mr-2 avatar avatar-sm"><img
                                                            class="avatar-img rounded-circle"
                                                            src="adminP/assets/img/doctors/doctor-thumb-04.jpg"
                                                            alt="User Image"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="mr-2 avatar avatar-sm"><img
                                                            class="avatar-img rounded-circle"
                                                            src="adminP/assets/img/doctors/doctor-thumb-05.jpg"
                                                            alt="User Image"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="mr-2 avatar avatar-sm"><img
                                                            class="avatar-img rounded-circle"
                                                            src="adminP/assets/img/patients/patient1.jpg" alt="User Image"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="mr-2 avatar avatar-sm"><img
                                                            class="avatar-img rounded-circle"
                                                            src="adminP/assets/img/patients/patient2.jpg" alt="User Image"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="mr-2 avatar avatar-sm"><img
                                                            class="avatar-img rounded-circle"
                                                            src="adminP/assets/img/patients/patient3.jpg" alt="User Image"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="mr-2 avatar avatar-sm"><img
                                                            class="avatar-img rounded-circle"
                                                            src="adminP/assets/img/patients/patient4.jpg" alt="User Image"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="mr-2 avatar avatar-sm"><img
                                                            class="avatar-img rounded-circle"
                                                            src="adminP/assets/img/patients/patient5.jpg" alt="User Image"></a>
