                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3 input-group">
                            ...
                            <input type="date" class="form-control"  id="start_date" placeholder="Semana Inicial" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 input-group">
                            ...
                            <input type="date" class="form-control" id="end_date" placeholder="Semana Final" readonly>
                        </div>
                    </div>
                </div>
                <div style="float:right;">
                    <button id="filter" class="btn btn-info btn-sm">Fitrar</button>
                    <button id="reset" class="btn btn-danger btn-sm">Limpiar</button>
                </div>
                <br>
                <br>
        <div class="card-body">
