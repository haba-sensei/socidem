...
?>
    ...
    <div class="card card-table flex-fill">
        <div class="card-header" style="display: inline-flex;">
            <h4 class="card-title" >Historial Pagos Referidos Externos <br>  Semana Actual (<?=$fecha_lunes?>) <br> Semana Termina (<?=$fecha_domingo?>)</h4>
        ...
        <div class="col-md-12" style="margin-bottom: -80px;">
                <div class="row">
                    ...
                    <button onclick="table_ref_externos()" class="btn btn-success btn-sm" >Buscar</button>
                    <button onclick="table_export_externos()" class="btn btn-info btn-sm">Exportar</button>
