<div class="main-wrapper">
			...
			<header class="header text-center ">
				<nav class="navbar text-center navbar-expand-lg header-nav">
					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="has-submenu">
								<a href="Inicio.html">Nuestros Servicios</a>
								
							</li>
							<li class="has-submenu">
								<a href="Inicio.html">Preguntas Frecuentes</a>
							...
							<li class="login-link">
								<a href="inicio-doctor.html">¿Es Usted Médico?</a>
							</li>
						</ul>		 
					</div>		 
					<ul class="nav header-navbar-rht">
						<li class="nav-item contact-item">
							...
							<div class="header-contact-detail">
								<a  href="login.html"> <p  href="login.html"class="contact-header">INGRESAR</p></a>
								<a  href="register.html"><p class="contact-header">REGISTRARSE</p></a>
							</div>
						</li>
						<li class="nav-item">
							<a class="nav-link header-login" href="inicio-doctor.html">¿Es Usted Médico? </a>
						</li>
					</ul>
				</nav>
			</header>
					...
					<div class="banner-wrapper">
						...
						<div class="search-box">
							<form action="">
								...
								<button type="submit" class="btn btn-primary search-btn mt-0"><i class="fas fa-search"></i> <span>Buscar</span></button>
							</form>
						</div>
						<!-- /Search -->
		...
		<!-- Category Section -->
			   ...
			   <!-- Availabe Features -->
			   <section class="section section home-tile-section">
				<div class="container-fluid">
				   <div class="row">
							...
							<div class="row">
								<div class="col-lg-4 mb-3">
									<div class="card text-center doctor-book-card">
										...
										<div class="doctor-book-card-content tile-card-content-1">
											<div>
												<h3 class="card-title mb-0">Reserva</h3>
								...
								<div class="col-lg-4 mb-3">
									<div class="card text-center doctor-book-card">
										...
										<div class="doctor-book-card-content tile-card-content-1">
											<div>
												<h3 class="card-title mb-0">Preguntas Frecuentes</h3>
								...
								<div class="col-lg-4 mb-3">
									<div class="card text-center doctor-book-card">
										...
										<div class="doctor-book-card-content tile-card-content-1">
											<div>
											<h3 class="card-title mb-0">Precios</h3>
...
<section class="section section-doctor">
	<div class="container-fluid">
		<div class="section-header text-center">
			<h2>Reserva con tu Médico Destacado</h2>
			...
			<div class="col-lg-12">
				<div class="doctor-slider slider">
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="views/assets/img/doctors/doctor-01.jpg">
							</a>
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="views/assets/img/doctors/doctor-02.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">	<i class="far fa-bookmark"></i>
							</a>
						</div>
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="views/assets/img/doctors/doctor-03.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">	<i class="far fa-bookmark"></i>
							</a>
						</div>
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="views/assets/img/doctors/doctor-04.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">	<i class="far fa-bookmark"></i>
							</a>
						</div>
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="views/assets/img/doctors/doctor-05.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">	<i class="far fa-bookmark"></i>
							</a>
						</div>
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="views/assets/img/doctors/doctor-06.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">	<i class="far fa-bookmark"></i>
							</a>
						</div>
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="views/assets/img/doctors/doctor-07.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">	<i class="far fa-bookmark"></i>
							</a>
						</div>
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="views/assets/img/doctors/doctor-08.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">	<i class="far fa-bookmark"></i>
							</a>
						</div>
						...
						<div class="row">
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-about">
									<div class="footer-logo">
										<img src="views/assets/img/footer-logo.png" width="200" alt="logo">
									</div>
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
										<li><a href="search.html">Búsqeuda</a></li>
										<li><a href="login.html">Login</a></li>
										<li><a href="register.html">Registro</a></li>
										<li><a href="booking.html">Reservas</a></li>
										<li><a href="patient-dashboard.html">Paciente Dashboard</a></li>
									</ul>
								</div>
								<!-- /Footer Widget -->
							...
							<div class="col-lg-3 col-md-6">
								...
								<!-- Footer Widget -->
								<div class="footer-widget footer-menu">
									<h2 class="footer-title">Para Doctores</h2>
									<ul>
										<li><a href="appointments.html">Reservas</a></li>
										<li><a href="login.html">Login</a></li>
										<li><a href="doctor-register.html">Registro</a></li>
