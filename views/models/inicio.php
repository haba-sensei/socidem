	                            ...
	                            <div class="text-center card doctor-book-card">
	                                ...
	                                <div class="doctor-book-card-content tile-card-content-1">
	                                    <div>
	                                        ...
	                                        <a href="pharmacy-search" class="px-3 py-2 mt-3 btn book-btn1"
	                            ...
	                            <div class="text-center card doctor-book-card">
	                                ...
	                                <div class="doctor-book-card-content tile-card-content-1">
	                                    <div>
	                                        ...
	                                        <a href="javascript:void(0);" class="px-3 py-2 mt-3 btn book-btn1"
	                    ...
	                    <div class="doctor-slider slider">
	                            ...
	                            <div class="doc-img">
	                                <a href="doctor-profile">
	                                    <img class="img-fluid" alt="User Image"
	                                        src="views/assets/img/doctors/doctor-01.jpg">
	                                </a>
	                        ...
	                        <div class="profile-widget">
	                            <div class="doc-img">
	                                <a href="doctor-profile">
	                                    <img class="img-fluid" alt="User Image"
	                                        src="views/assets/img/doctors/doctor-02.jpg">
	                                </a>
	                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
	                                </a>
	                            </div>
	                        ...
	                        <div class="profile-widget">
	                            <div class="doc-img">
	                                <a href="doctor-profile">
	                                    <img class="img-fluid" alt="User Image"
	                                        src="views/assets/img/doctors/doctor-03.jpg">
	                                </a>
	                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
	                                </a>
	                            </div>
	                        ...
	                        <div class="profile-widget">
	                            <div class="doc-img">
	                                <a href="doctor-profile">
	                                    <img class="img-fluid" alt="User Image"
	                                        src="views/assets/img/doctors/doctor-04.jpg">
	                                </a>
	                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
	                                </a>
	                            </div>
	                        ...
	                        <div class="profile-widget">
	                            <div class="doc-img">
	                                <a href="doctor-profile">
	                                    <img class="img-fluid" alt="User Image"
	                                        src="views/assets/img/doctors/doctor-05.jpg">
	                                </a>
	                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
	                                </a>
	                            </div>
	                        ...
	                        <div class="profile-widget">
	                            <div class="doc-img">
	                                <a href="doctor-profile">
	                                    <img class="img-fluid" alt="User Image"
	                                        src="views/assets/img/doctors/doctor-06.jpg">
	                                </a>
	                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
	                                </a>
	                            </div>
	                        ...
	                        <div class="profile-widget">
	                            <div class="doc-img">
	                                <a href="doctor-profile">
	                                    <img class="img-fluid" alt="User Image"
	                                        src="views/assets/img/doctors/doctor-07.jpg">
	                                </a>
	                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
	                                </a>
	                            </div>
	                        ...
	                        <div class="profile-widget">
	                            <div class="doc-img">
	                                <a href="doctor-profile">
	                                    <img class="img-fluid" alt="User Image"
	                                        src="views/assets/img/doctors/doctor-08.jpg">
	                                </a>
	                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
	                                </a>
	                            </div>
