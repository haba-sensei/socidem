            ...
            <div class="col-md-7 col-lg-8 col-xl-9">
                ...
                <div class="tab-content ">
                    ...
                    <div class="tab-pane show active" id="historial">
                        <button type="button" class="btn  med_row "><i class="fa fa-plus"></i> AGREGAR HISTORIA CLINICA</button>
                        ...
                        foreach ($historia_clinica as $key => $entry) { 
                            ...
                            <div id="h'.$count.'" class="collapse" style="margin-top: 15px; margin-bottom: 15px;">
                                 '.$entry['texto'].'
                                 <br><br>
                                 <button type="button" class="btn med_row "  ><i class="fas fa-edit"></i> EDITAR</button>
                            </div>
                    ...
                    <div class="tab-pane" id="analisis_lab">
                        ...
                        <button type="button" class="btn  med_row"  ><i class="fa fa-plus"></i>
                    ...
                    <div class="tab-pane" id="imagenes_digitales">
                        <button type="button" class="btn   med_row "><i
                                class="fa fa-plus"></i>
                            AGREGAR IMAGENES DIGITALES</button>
