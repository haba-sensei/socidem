 (function(root, factory) {
     ...
     var content = $('<div class="timepicker">\
		<div v-show class="title">Elige una hora</div>\
			<div class="chose-all">\
				<div class="handle">\
				...
				<div class="text">\
					<div class="cell-4"><a class="js-hour-show" title="Elige la Hora"></a></div>\
					<div class="cell-2">:</div>\
					<div class="cell-4"><a class="js-minute-show" title="Elige los Minutos"></a></div>\
				</div>\
				<div class="handle">\
     ...
     timepicker.bindEvent = function() {
         ...
         this.content.on('click', '.js-minus-minute', function() {
             ...
             thisTimePicker.title.text('Hora Actual');
