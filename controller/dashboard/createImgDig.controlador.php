...
include '../../model/sessiones.php';
 ...
 $cod_correo = $_POST['cod_correo'];
    ...
    while($datos_analisis_lab=mysqli_fetch_assoc($verAnalisis_lab)){
        ...
        $objAL=$datos_analisis_lab['img_digitales'];
        ...
        if (!empty($_FILES['file']['name'])) {
            ...
            for ($i=0; $i < $totalFile ; $i++) {
                ...
                $uploadFilePath = "../../views/assets/images/historial/img_digitales/".$newName;
            ...
            consultasSQL::UpdateSQL("historial_medico", "img_digitales='$insertar_data'", "correo='$cod_correo'");
