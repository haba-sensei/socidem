...
echo ' 
    ...
    if($dia == "Lunes") {
        ...
        <div class="col-md-6"><button type="button" class="btn btn-new btn-info btn-block" style="background: #008298; border: 1px solid #ececec; "  onclick="subir(&quot;'.$id_track.'&quot;)" ><i class="fas fa-save"></i>  Guardar Agenda del dia </button></div>
