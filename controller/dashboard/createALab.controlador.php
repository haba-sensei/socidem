...
include '../../model/sessiones.php';
 ...
 $cod_correo = $_POST['cod_correo'];
    ...
    while($datos_analisis_lab=mysqli_fetch_assoc($verAnalisis_lab)){
        ...
        $objAL=$datos_analisis_lab['analisis_lab'];
        ...
        if (!empty($_FILES['file']['name'])) {
            ...
            for ($i=0; $i < $totalFile ; $i++) {
                ...
                $uploadFilePath = "../../views/assets/images/historial/analisis_lab/".$newName;
            ...
            consultasSQL::UpdateSQL("historial_medico", "analisis_lab='$insertar_data'", "correo='$cod_correo'");
